...
const hoverEffect = function ($obj) {
    ...
    var allImgs = [], running = false, loded = false, disp, oldIndex = 0, current = 0;
    ...
    getRenderer()
        ...
        .then(() => {
            ...
            $obj.imgs.forEach(({src, poster = false}, x) => {
                if (poster)
                    video(src, poster, x);
                else
                    image(src, x);
        ...
        .then(() => {
            this.mat = new THREE.ShaderMaterial({
                ...
                uniforms: {
                    effectFactor: {type: "f", value: $obj.intensity},
                    dispFactor: {type: "f", value: 0},
                    texture: {type: "t", value: allImgs[0]},
                    texture2: {type: "t", value: allImgs[0]},
    ...
    this.changeTo = function ($index, $oldIndex) {
        ...
        gsap.fromTo(this.mat.uniforms.dispFactor, $obj.speedIn, {value: 0}, {
            value: 1,
            ease: $obj.easing,
